...
For example, NOAA's Deep Space Climate Observatory (DSCOVR) satellite images the entire Earth as frequently as every hour, but the orbit required to achieve this is very high and therefore the satellite's effective spatial resolution is relatively poor -- around 24 x 24 square kilometers.
...
Remote sensing is an essential data source for the earth system modeling activities of the Earth and Biological Sciences Directorate (ASGC).
